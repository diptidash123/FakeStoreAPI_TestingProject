...
public class AddNewProductApiTest extends BaseTest_Extent
{
    ...
    @Test(description = "AddNewProduct_API",priority = 1)
    public void AddNewProductApiTest_PTC001()
    {
        ...
        //Extent logs print
        extentTest.info("Requesting AddNewProductApiTest_PTC001");
    ...
    public void AddNewProductApiTest_NTC002()
    {
        ...
        AddNewProduct_API pojo_call=new AddNewProduct_API();
        pojo_call.setTitle(" ");
        pojo_call.setPrice(0);
        pojo_call.setDescription(" ");
        pojo_call.setImage(" ");
        pojo_call.setCategory("");
        ...
        Response response = given()
                ...
                .when().post(Endpoints.path_url_AddNewProduct_API)
                //Call the jsonschema validator
                .then().statusCode(Statuscode_Repo.bad_request.code).body(JsonSchemaValidator.matchesJsonSchema(file)).extract().response();
        System.out.println("Schema validation is passed");
        //.then().statusCode(Statuscode_Repo.created.code).extract().response();
        System.out.println(response.body().asString());
        //Deserialization
        ...
        //Extent logs print
        extentTest.info("Requesting AddNewProductApiTest_NTC002");
        extentTest.info("Status Code: " + response.getStatusCode());
        extentTest.info("Response Body: " + response.asPrettyString() );
        extentTest.assignCategory("Test Suite: " + " " + "Sanity");
        extentTest.assignAuthor("Dipti Ranjan Dash");
    ...
    public void AddNewProductApiTest_NTC003()
    {
        ...
        //Extent logs print
        extentTest.info("Requesting AddNewProductApiTest_NTC003");
        extentTest.info("Status Code: " + response.getStatusCode());
        extentTest.info("Response Body: " + response.asPrettyString() );
        extentTest.assignCategory("Test Suite: " + " " + "Sanity");
        extentTest.assignAuthor("Dipti Ranjan Dash");
